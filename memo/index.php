    ...
    <div class="h-100">
      <div class="row h-100 m-0 p-0">
        <div class="col-3 h-100 m-0 p-0 border-left border-right border-gray">
          ...
          <div class="left-memo-title h3 pl-3 pt-3">メモリスト</div>
        ...
        <div class="col-9 h-100">
          <form action="" method="post" class="w-100 h-100">
            ...
            <textarea name="edit_content" id="memo-content" cols="30" rows="10" placeholder="内容を入力する..."></textarea>
          </form>
        </div>
      </div>
    </div>

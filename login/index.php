        ...
        <div class="card rounded login-card-width shadow">
          <div class="card-body">
            <div class="rounded-circle mx-auto border-gray border d-flex mt-3 icon-circle">
              <img src="../public/images/animal_stand_zou.png" alt="loginicon" class="w-75 mx-auto p-2">
            </div>
            ...
            <div class="row mt-3">
              <div class="offset-2 col-8 offset-2">
                <label for="" class="input-group w-100">
                ...
                <button class="form-control btn btn-success">ログイン</button>
              </div>
            </div>
            <div class="mt-5">
              <div class="d-flex justify-content-center">
